 ...
 *      **ผลที่ได้ต้องผ่านด่านคุณภาพเหมือนกัน** พิกัดระดับอำเภอ/จังหวัด (ด่าน
 *      types[]/partial_match) ถูกปฏิเสธ ส่วนที่เหลือผ่านหมด **ไม่ว่าจะคลาด
 *      เคลื่อนไกลแค่ไหน** แล้วติดชั้นความละเอียดไว้ให้ UI ขึ้นป้าย
 *      — เดิมเส้นทางนี้ปักหมุดทุกอย่างที่ Google คืนมาโดยไม่บอกอะไรเลย
 *      ซึ่งเป็นรูสุดท้ายของหลักการ "เมื่อไม่แน่ใจ ห้ามปักหมุด" หลักการนั้นยัง
 *      อยู่ แต่ "ไม่แน่ใจ" หมายถึงคุณภาพของ geocode ไม่ใช่ระยะทาง
