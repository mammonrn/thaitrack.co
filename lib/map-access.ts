 ...
 *
 * ⚠️ ด่านนี้เป็นชั้นที่ 1 — มันปิดรูได้เพราะสวิตช์ปิดอยู่ **ไม่ใช่เพราะรูถูกอุด**
 *
 * ชั้นที่ 2 ทำครบแล้วใน app/api/map/route.ts: จำกัดพิกัดในกรอบไทย, ปัดพิกัด
 * 4 ตำแหน่งให้ cache ทำงาน, cache ภาพฝั่งเซิร์ฟเวอร์, ตัวนับ, เพดานรายวัน
 * — เปิด map_enabled กลับมาได้โดยไม่เปิดรูทิ้งไว้ (มีเทสต์เฝ้าทั้งสองชั้น)
 * ══════════════════════════════════════════════════════════════════
 */
